...
class ChatScreen extends StatelessWidget {
  ...
  void checkAndUpdateLastMessageSeen(
      Message lastMessage, String? messageId, String myUserId, String otherUserId) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.data?.docs.length != 0) {
                      checkAndUpdateLastMessageSeen(
                          messages.first, snapshot.data?.docs[0].id, myUserId, otherUserId);
                    }
          ...
          getBottomContainer(context, myUserId, otherUserId)
        ]));
  }

  void sendMessage(String myUserId, String otherUserId) {
  ...
  Widget getBottomContainer(BuildContext context, String myUserId, String otherUserId) {
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            RaisedButton(
              ...
              onPressed: () {
                sendMessage(myUserId, otherUserId);
              },
            ),
          ],
        ),
